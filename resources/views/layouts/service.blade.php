...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="../../../public/css/agencybootstrap.min.css" rel="stylesheet">
      ...
      <div class="container">
        ...
        <div class="row text-center">
          ...
          <div class="col-md-4 animate-box">
            ...
            <h4 class="service-heading">3. Booking</h4>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center"><!-- 
            <h2 class="section-heading text-uppercase">Cara Kerja</h2> -->
            <!-- <h3 class="section-subheading text-muted"></h3> -->
          </div>
        </div>
        <div class="row text-center">
          ...
          <div class="col-md-4 animate-box">
            ...
            <h4 class="service-heading">6. Maintenance</h4>
            <p class="text-muted">HelpYow bekerjasama dengan pengguna jasa dan pekerja untuk memonitor perkembangan kedua belah pihak untuk saling mendapatkan hak dan menjalankan kewajibannya masing-masing.</p>
          </div>
